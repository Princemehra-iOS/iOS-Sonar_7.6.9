...
open class ChartColorTemplates: NSObject
{
    ...
    @objc open class func colorful () -> [NSUIColor]
    {
        return [
            ...
            NSUIColor(red: 1.0, green: 102/255.0, blue: 0/255.0, alpha: 1.0),
    ...
    {
        return [
            NSUIColor(red: 192/255.0, green: 1.0, blue: 140/255.0, alpha: 1.0),
            NSUIColor(red: 1.0, green: 247/255.0, blue: 140/255.0, alpha: 1.0),
            NSUIColor(red: 1.0, green: 208/255.0, blue: 140/255.0, alpha: 1.0),
            NSUIColor(red: 140/255.0, green: 234/255.0, blue: 1.0, alpha: 1.0),
            NSUIColor(red: 1.0, green: 140/255.0, blue: 157/255.0, alpha: 1.0)
        ]
    }
