//
//  RequestParametersBuilderForTurkey.swift
//  Zoetis -Feathers
//
//  Created by Pankush Dhawan on 19/12/25.
//

import Foundation

struct TurkeyRequestPayloadBuilder {
    
    static var postingIdArr = NSMutableArray()

    static func getNecropsyJSONForTurkey(postingId: NSNumber) -> [String:Any]?{
        var complexId = Int()
    ...
    static func getPostingJSONForTurkey(postingId :NSNumber) -> [String: Any]? {
        let lngId = UserDefaults.standard.integer(forKey: "lngId")
    ...
    static func getVaccinationForTurkey(postingId:NSNumber) -> [String: Any]? {
    ...
    static func handlePostingIdArr(_ vaccinationName: inout String, _ postingArrWithAllData: NSMutableArray, _ sessionArr: NSMutableArray) {
    ...
    static func handleFieldVacinationAllArr(_ FieldVacinationAll: NSArray, _ vaccinationDetail: NSMutableDictionary) {
    ...
    static func handleAddVacinationAll(_ addVacinationAll: NSArray, _ vaccinationName: inout String, _ vaccinationDetail: NSMutableDictionary) {
    ...
    static func handlecNecArray(_ cNecArr: NSArray, _ necArrWithoutPosting: NSMutableArray) {
        for j in 0..<cNecArr.count
        {
            let captureNecropsyData = cNecArr.object(at: j)  as! CaptureNecropsyDataTurkey
    ...
    static func handlePostingArrWithAllData(_ postingArrWithAllData: NSMutableArray, _ sessionId: inout NSNumber, _ timeStamp: inout String, _ actualTemp: NSMutableArray, _ tempArrTime: NSMutableArray) {
        for i in 0..<postingArrWithAllData.count {
     ...
     static func getFeedProgramJSONForTurkey(forPostingId postingId: NSNumber) -> [String: Any]? {
    ...
    static func getCompleteSyncJSONForTurkey(forPostingId postingId: NSNumber) -> [String: Any] {
